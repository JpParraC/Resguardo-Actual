            ...
            <div class="section__content section__content--p30">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="title-5 m-b-35">TABLA DEL PERSONAL</h3>
                        <div class="table-data__tool">
                            
                            <div class="table-data__tool-right">
                                
                                <div class="rs-select2--dark rs-select2--sm rs-select2--dark2">
                                    <a class="btn btn-primary" target="_blank" href="./php/listadocompletofnc.php" role="button">Descargar Listado</a>
                                    
                                    

                                      <!-- Agrega esto en la parte donde quieras el buscador -->
                             
                                </div>

                            </div>
                            <form id="searchForm">
                                        <input class="search" type="text" id="searchInput" name="searchTerm" placeholder="Buscar..." title="Ingrese el Nùmero de cédula de la persona que necesita buscar">
            ...
            function updateTable(results) {
                ...
                $.each(results, function (index, row) {
                    var newRow = '<tr>' +
                        ...
                        '<div class="btn-group">' +
                        '<button class="btn btn-green smallicon" data-toggle="tooltip" data-placement="top" title="Editar"><i class="zmdi zmdi-edit zmdi-hc-xs"></i></button>' +

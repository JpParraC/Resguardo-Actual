...
<body class="animsition">
            ...
            <div class="main-content">
                <div class="row">
                    <div class="col-md-9 offset-md-3 mr-auto ml-auto">
                      <section class="card">
                        <div class="card-body text-secondary text-center">Debe seleccionar una opción para ver el listado de Funcionarios pertenecientes a ese Comando</div>
                      </section>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <section class="card">
                            <div class="card-body text-secondary text-center">
                                <label for="comandos">Seleccione el comando requerido:</label>
                                <select id="comandos" onchange="redireccionar()">
                                    <option value="">Seleccione una opción</option>
                                    <option value="./listadocmdo1.php">Comando 1</option>
                                    <option value="./listadocmdo2.php">Comando 2</option>
                                    <option value="./listadocmdo3.php">Comando 3</option>
                ...
                <div class="table-responsive col-lg-10 mx-auto">
                    <table class="table table-borderless table-data3">
                        ...
                        <?php include('./php/mostrarcmdoyfnc3.php'); ?>
    ...
    function redireccionar() {
        var seleccion = document.getElementById("comandos").value;

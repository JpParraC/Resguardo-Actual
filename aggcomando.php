                    ...
                    <div class="col-lg-6 mx-auto">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-center">Agregar Comando</h3>
                                
                            </div>
                            <div class="card-body card-block">
                                <form action="./php/aggcmd.php">
                                <div class="form-group">
                                    <label for="vat" class=" form-control-label">Codigo Comando</label>
                                    <input type="text" id="vat" name="cd" placeholder="1234" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="company" class=" form-control-label">Nombre del CPP</label>
                                    <input type="text" id="company" name="nn" placeholder=" ingrese el nombre del CPP" class="form-control">
                                </div>
                             
                                <div class="form-group">
                                    <label for="street" class=" form-control-label">Descripción Direccion</label>
                                    <input type="text" id="street" name="dir" placeholder="Describa la direccion" class="form-control">
                                </div>
